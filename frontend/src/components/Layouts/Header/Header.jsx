...
import bars from '../../../assets/images/bars.jpeg';
...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-primary-blue fixed top-0 py-2.5 w-full z-10">
      ...
      <Link to='/'>
        <img className='w-20' style={{borderRadius: '50%'}} src={bars} /> 
      </Link>
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          {isAuthenticated === false ?
            ...
            (
              ...
              onClick={() => setTogglePrimaryDropDown(!togglePrimaryDropDown)}>{user.name && user.name.slice(0, 2)}
                <span>{togglePrimaryDropDown ? <ExpandLessIcon sx={{ fontSize: "16px" }} /> 
